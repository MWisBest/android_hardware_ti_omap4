...
#ifdef CAMERAHAL_TUNA
    if (caps.tSenMounting.nSenId == SENSORID_S5K4E1GA) {
        params->set(CameraProperties::FOCAL_LENGTH, "3.43"); // DEFAULT_FOCAL_LENGTH_PRIMARY
    } else {
        params->set(CameraProperties::FOCAL_LENGTH, "1.95"); // DEFAULT_FOCAL_LENGTH_SECONDARY
    }
#endif
