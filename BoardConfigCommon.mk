...
TARGET_EXTRA_CFLAGS += -DENHANCED_DOMX
ENHANCED_DOMX := true
...
ifeq ($(BOARD_USE_TI_LIBION),true)
    TARGET_EXTRA_CFLAGS += -DUSE_TI_LIBION
endif

ifdef OMAP_ENHANCEMENT
    TARGET_EXTRA_CFLAGS += -DOMAP_ENHANCEMENT -DTARGET_OMAP4 -DFORCE_SCREENSHOT_CPU_PATH
endif

ifdef OMAP_ENHANCEMENT_BURST_CAPTURE
    TARGET_EXTRA_CFLAGS += -DOMAP_ENHANCEMENT_BURST_CAPTURE
endif

ifdef OMAP_ENHANCEMENT_S3D
    TARGET_EXTRA_CFLAGS += -DOMAP_ENHANCEMENT_S3D
endif

ifdef OMAP_ENHANCEMENT_CPCAM
    TARGET_EXTRA_CFLAGS += -DOMAP_ENHANCEMENT_CPCAM
    PRODUCT_MAKEFILES += $(LOCAL_DIR)/sdk_addon/ti_omap_addon.mk
endif

ifdef OMAP_ENHANCEMENT_VTC
    TARGET_EXTRA_CFLAGS += -DOMAP_ENHANCEMENT_VTC
endif

ifdef USE_ITTIAM_AAC
    TARGET_EXTRA_CFLAGS += -DUSE_ITTIAM_AAC
endif

ifdef OMAP_ENHANCEMENT_MULTIGPU
    TARGET_EXTRA_CFLAGS += -DOMAP_ENHANCEMENT_MULTIGPU
endif
